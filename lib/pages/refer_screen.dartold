      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'success') {
          ...
          setState(() {
            ...
            _totalRefers = user['total_refers']?.toString() ?? "0";
            _earnings = user['referral_earnings']?.toString() ?? "0.00";
            _isLoading = false;
          });
        }
      }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        _buildStatCard("Total Refers", _totalRefers),
                        _buildStatCard("Earnings", "$_earnings LTC"),
                      ],
                    ),
