...
class _MiningScreenState extends State<MiningScreen>
  ...
  Future<void> _executeClaim() async {
    ...
    try {
      ...
      final bool cycleComplete = message.contains('complete') ||
          (newWithdrawable - prevWithdrawable) >= 99.0;

      final double withdrawableAdded = cycleComplete ? 100.0 : 0.0;
                    ...
                    if (_c.isMining) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: orbAccent.withOpacity(0.4)),
                        ),
                        child: Text(
                          "+\$${_c.usdPerSec.toStringAsFixed(6)}/s",
                          style: GoogleFonts.spaceMono(
                            color: orbAccent, fontSize: 10.sp,
                            fontWeight: FontWeight.bold)),
                      ),
                    ],
                  ],
  ...
  Widget _buildActionButtons() {
    return Row(
      children: [
        Expanded(
          child: _buildActionButton('Claim', AppColors.accentGreen,
              CupertinoIcons.money_dollar_circle_fill, _handleClaimTap),
        ),
        SizedBox(width: 12.w),
        Expanded(
          child: _buildActionButton('Refresh', Colors.blue,
              CupertinoIcons.refresh, _c.fetchStatus),
        ),
      ],
    );
  }
    ...
    return Animate(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: AppColors.accentGreen.withOpacity(0.1),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 12.h),
                        Text("\$${_c.liveUSD.toStringAsFixed(4)}",
                          style: GoogleFonts.spaceMono(
                            color: Colors.white, fontSize: 28.sp,
                            fontWeight: FontWeight.bold)),
                      ],
              ...
              if (!active)
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(colors: [
                        AppColors.accentGreen, Color(0xFF00CC88)]),
                      borderRadius: BorderRadius.circular(12.r),
                    ),
                    child: Text("BUY \$10",
                      style: GoogleFonts.inter(
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(maxed ? "MAXED" : "+ BUY",
                        style: GoogleFonts.inter(
                          color:
                              maxed ? Colors.white38 : Colors.white,
                          fontSize: 11.sp,
                          fontWeight: FontWeight.bold)),
                    ),
                  ),
