...
class _WalletScreenState extends State<WalletScreen> with TickerProviderStateMixin {
  ...
  Future<void> _loadAll({bool silent = false}) async {
    ...
    try {
      ...
      developer.log('Fetching deposit info...', name: 'WalletScreen');
  ...
  void _showDepositSheet() {
    developer.log('Opening deposit sheet with wallet: $_platformWallet', name: 'WalletScreen');
    
    if (_platformWallet.isEmpty) {
      _showErrorSnackBar('Wallet address not loaded. Please refresh.');
      return;
    }
