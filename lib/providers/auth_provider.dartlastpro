...
class AuthProvider extends ChangeNotifier {
  ...
  final _appLinks = AppLinks(); // ✅ deep link instance
  ...
  Future<void> initDeepLinks() async {
    try {
      // App বন্ধ থাকা অবস্থায় লিংক দিয়ে খুললে
      ...
      // App চালু থাকা অবস্থায় লিংক আসলে
  ...
  // =========================
  // INIT FULL ✅ deep link আগে
  // =========================
  Future<void> initAuth(BuildContext context) async {
    await initDeepLinks(); // ✅ সবার আগে deep link init
    await initTokenOnly();
  ...
  Future<bool> _loginToBackend(String walletAddress) async {
    ...
    try {
      ...
      debugPrint("Referred by: $_inputReferralCode"); // ✅ debug করার জন্য
